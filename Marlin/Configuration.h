...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, SKR-mini-E3-V3.0)" // M. Sheridan 2025-10-07.
...
#define CUSTOM_MACHINE_NAME "Ender-3 DD BLTouch"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 39.90
  #define DEFAULT_bedKi 2.08
  #define DEFAULT_bedKd 509.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 149.61 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 31, 0, -2.5 }
