...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3 Pro)" // Who made the changes. (Updated 10/7/2025)
...
#define CUSTOM_MACHINE_NAME "Finn Ender-3 Pro - SKRe3v2 - BLTouch"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kp_LIST {  26.17,  26.17 }
    #define DEFAULT_Ki_LIST {   2.14,   2.14 }
    #define DEFAULT_Kd_LIST {  80.09,  80.09 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 103.065 }
